...
TEST_CASE("Forward-reference oracle recognizes Luau local bindings", "[Fuzz][ForwardRef][Regression]") {
    const std::string source = GENERATE(
        "local function v0() local v0 = {} return v0 end v0()", "for v2 in next, {} do print(v2) end local v2 = 1 print(v2)",
        "for v6 in next, {} do for v7 in next, {} do print(v7) end end local v6 = 1 print(v6)", "local v1_3, v2 = 1, 2 print(v2) local v2 = 3 print(v2)"
    );
