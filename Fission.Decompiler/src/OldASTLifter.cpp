...
std::shared_ptr<Expression> OldASTLifter::LiftCallLikeInstruction(const AnalyzedFunction *func, int32_t index, bool isNested) {
...
std::shared_ptr<Expression> OldASTLifter::LiftExpression(const AnalyzedFunction *func, const LiftedOperand &operand, bool forceExpression) {
...
std::vector<std::shared_ptr<Statement>> OldASTLifter::LiftBlockInstructions(const AnalyzedFunction *func, const BasicBlock &block) {
...
OldASTLifter::LiftTree(AnalyzedFunction *func, uint32_t currentBlockId, uint32_t stopBlockId, std::set<uint32_t> &visited) {
...
ASTFunction OldASTLifter::LiftFunctionInternal(AnalyzedFunction *analyzedFunction) {
    ASTFunction astFunc;
...
ASTFunction OldASTLifter::LiftFunction(AnalyzedFunction *analyzedFunction) {
